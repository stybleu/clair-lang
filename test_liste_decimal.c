...
int main(void){
ClairDoubleList valeurs = clair_double_list_make((double[]){1.5, 2.5, 3.5}, 3LL);
...
clair_double_list_append(&valeurs, (double)(4.5));
...
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Dernier :")); nv_call_add(&__c, nv_float(clair_double_list_get(&valeurs, (long long)(3LL)))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
