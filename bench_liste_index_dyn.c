...
int main(void){
NvVal nombres = ({ NvVal __l = nv_list_new(); nv_list_append(__l, nv_int(10LL)); nv_list_append(__l, nv_int(20LL)); nv_list_append(__l, nv_int(30LL)); nv_list_append(__l, nv_int(40LL)); nv_list_append(__l, nv_int(50LL)); __l; });
NvVal somme = nv_int(0LL);
...
while (nv_truth(nv_lt(clair_range_index_1, clair_range_fin_1))) {
    ...
    somme = nv_add(somme, nv_get_index(nombres, nv_mod(i, nv_int(5LL))));
