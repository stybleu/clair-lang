...
int main(void){
NvVal nombres = ({ NvVal __l = nv_list_new(); nv_list_append(__l, nv_int(10LL)); nv_list_append(__l, nv_int(20LL)); nv_list_append(__l, nv_int(30LL)); nv_list_append(__l, nv_int(40LL)); __l; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Premier :")); nv_call_add(&__c, nv_get_index(nombres, nv_int(0LL))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Troisieme :")); nv_call_add(&__c, nv_get_index(nombres, nv_int(2LL))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_int(50LL)); NvVal __r = nv_dispatch_method(nombres, "ajoute", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Longueur :")); nv_call_add(&__c, ({ NvCall __c = nv_call_new(); nv_call_add(&__c, nombres); NvVal __r = nv_dispatch_call("longueur", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; })); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Dernier :")); nv_call_add(&__c, nv_get_index(nombres, nv_int(4LL))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Liste :")); nv_call_add(&__c, nombres); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
    return 0;
}
