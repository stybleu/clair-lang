...
int main(void){
ClairString gauche1 = clair_string_literal("Al");
ClairString droite1 = clair_string_literal("ice");
ClairString nom = clair_string_concat_many((ClairString[]){gauche1, droite1}, 2LL);
ClairString gauche2 = clair_string_literal("A");
ClairString droite2 = clair_string_literal("lice");
ClairString cible = clair_string_concat_many((ClairString[]){gauche2, droite2}, 2LL);
long long compteur = 0LL;
long long clair_range_index_1 = 0LL;
long long clair_range_fin_1 = 50000000LL;
long long clair_range_pas_1 = 1LL;
while (((clair_range_index_1 < clair_range_fin_1))) {
    long long i = clair_range_index_1;
    if (nv_truth(nv_bool(clair_string_eq(nom, cible)))) {
