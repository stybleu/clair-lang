...
int main(void){
ClairIntList nombres = clair_int_list_make((long long[]){10LL, 20LL, 30LL, 40LL}, 4LL);
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Premier :")); nv_call_add(&__c, nv_int(clair_int_list_get(&nombres, (long long)(0LL)))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Troisieme :")); nv_call_add(&__c, nv_int(clair_int_list_get(&nombres, (long long)(2LL)))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
clair_int_list_append(&nombres, (long long)(50LL));
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Longueur :")); nv_call_add(&__c, nv_int((long long)nombres.len)); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Dernier :")); nv_call_add(&__c, nv_int(clair_int_list_get(&nombres, (long long)(4LL)))); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
(void)({ NvCall __c = nv_call_new(); nv_call_add(&__c, nv_str("Liste :")); nv_call_add(&__c, clair_int_list_box(&nombres)); NvVal __r = nv_dispatch_call("ecris", __c.args, __c.argc, __c.kw); nv_call_free(&__c); __r; });
    return 0;
}
